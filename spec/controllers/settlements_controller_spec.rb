...
describe SettlementsController do
  ...
  def mock_settlement(stubs={})
    @mock_settlement ||= mock_model(Settlement, stubs)
  end

  describe "GET index" do
    it "assigns all settlements as @settlements" do
      Settlement.stub(:find).with(:all).and_return([mock_settlement])
      get :index
      assigns[:settlements].should == [mock_settlement]
    end
  end

  describe "GET show" do
    it "assigns the requested settlement as @settlement" do
      Settlement.stub(:find).with("37").and_return(mock_settlement)
      get :show, :id => "37"
      assigns[:settlement].should equal(mock_settlement)
    end
  end

  describe "GET new" do
    it "assigns a new settlement as @settlement" do
      Settlement.stub(:new).and_return(mock_settlement)
      get :new
      assigns[:settlement].should equal(mock_settlement)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created settlement as @settlement" do
        Settlement.stub(:new).with({'these' => 'params'}).and_return(mock_settlement(:save => true))
        post :create, :settlement => {:these => 'params'}
        assigns[:settlement].should equal(mock_settlement)
      end

      it "redirects to the created settlement" do
        Settlement.stub(:new).and_return(mock_settlement(:save => true))
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved settlement as @settlement" do
        Settlement.stub(:new).with({'these' => 'params'}).and_return(mock_settlement(:save => false))
        post :create, :settlement => {:these => 'params'}
        assigns[:settlement].should equal(mock_settlement)
      end

      it "re-renders the 'new' template" do
        Settlement.stub(:new).and_return(mock_settlement(:save => false))
        post :create, :settlement => {}
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      it "updates the requested settlement" do
        Settlement.should_receive(:find).with("37").and_return(mock_settlement)
        mock_settlement.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => "37", :settlement => {:these => 'params'}
      end

      it "assigns the requested settlement as @settlement" do
        Settlement.stub(:find).and_return(mock_settlement(:update_attributes => true))
        put :update, :id => "1"
        assigns[:settlement].should equal(mock_settlement)
      end
    ...
    describe "with invalid params" do
      ...
      it "assigns the settlement as @settlement" do
        Settlement.stub(:find).and_return(mock_settlement(:update_attributes => false))
        put :update, :id => "1"
        assigns[:settlement].should equal(mock_settlement)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the settlements list" do
      Settlement.stub(:find).and_return(mock_settlement(:destroy => true))
      delete :destroy, :id => "1"
